        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="relative z-10 text-center lg:text-left">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-accent/10 border border-accent/20 rounded-full text-accent font-semibold text-xs sm:text-sm mb-4 sm:mb-6 animate-in slide-in-from-left-5 duration-700">
                <Sparkles className="w-3 h-3 sm:w-4 sm:h-4" />
                Premium Collection 2024
              </div>
              
              {/* Main Heading */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 leading-tight animate-in slide-in-from-left-5 duration-700 delay-100">
                Discover Premium{" "}
              ...
              {/* Description */}
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0 animate-in slide-in-from-left-5 duration-700 delay-200">
              ...
              {/* Stats */}
              <div className="flex items-center justify-center lg:justify-start gap-4 sm:gap-8 mb-6 sm:mb-8 animate-in slide-in-from-left-5 duration-700 delay-300">
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-in slide-in-from-left-5 duration-700 delay-400">
                <Link
                  href="/products"
                  className="group inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-primary-foreground font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl active:scale-[0.98]"
                >
                  Shop Now
                ...
                <Link
                  href="#features"
                  className="group inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-semibold rounded-xl transition-all duration-200"
                >
                  Learn More

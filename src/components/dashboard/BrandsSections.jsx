  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6 lg:p-0">
      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">Brands Management</h1>
          <p className="text-sm sm:text-base text-muted-foreground mt-1">Manage your product brands and their information</p>
        </div>
        <div className="flex items-center gap-3">
          <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-primary-foreground rounded-xl transition-all duration-200 font-semibold shadow-lg hover:shadow-xl text-sm sm:text-base">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
        <div className="bg-card border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-50 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0">
              <Building2 className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" />
            </div>
            <div>
              <p className="text-xl sm:text-2xl font-bold text-foreground">{brands.length}</p>
              <p className="text-xs sm:text-sm text-muted-foreground">Total Brands</p>
            </div>
          </div>
        </div>
        <div className="bg-card border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-50 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0">
              <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-600" />
            </div>
            <div>
              <p className="text-xl sm:text-2xl font-bold text-foreground">{brands.filter(b => b.status !== false).length}</p>
        ...
        <div className="bg-card border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-50 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0">
        ...
        <div className="bg-card border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-50 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0">
              <Eye className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" />
            </div>
            <div>
              <p className="text-xl sm:text-2xl font-bold text-foreground">{filteredBrands.length}</p>
      ...
      <div className="bg-card border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-2.5 sm:py-3 text-sm sm:text-base bg-input border border-border rounded-lg sm:rounded-xl outline-none transition-all duration-200 focus:ring-2 focus:ring-ring focus:border-accent placeholder:text-muted-foreground"
            />
            {searchTerm && (
              <button
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              ...
              className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition-all text-sm sm:text-base ${
                showFilters 
            ...
            {selectedBrands.length > 0 && (
              <div className="flex items-center gap-2 bg-muted px-3 py-2 rounded-lg">
                ...
                <button className="p-1.5 sm:p-2 text-destructive hover:bg-destructive/10 rounded-lg transition-colors">
        ...
        {/* Advanced Filters */}
        {showFilters && (
          <div className="mt-4 p-3 sm:p-4 bg-muted/50 rounded-lg sm:rounded-xl border border-border/50">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <h3 className="text-sm sm:text-base font-semibold text-foreground">Advanced Filters</h3>
              <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <select className="px-3 sm:px-4 py-2 text-sm sm:text-base bg-input border border-border rounded-lg sm:rounded-xl outline-none focus:ring-2 focus:ring-ring">
              ...
              <select className="px-3 sm:px-4 py-2 text-sm sm:text-base bg-input border border-border rounded-lg sm:rounded-xl outline-none focus:ring-2 focus:ring-ring sm:col-span-2 lg:col-span-1">
